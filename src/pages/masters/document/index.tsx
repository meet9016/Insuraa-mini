...
import { validateDocumentMaster } from '@/utils/validation';
...
export default function DocumentList() {
  ...
  const handleSave = async () => {
    const errorMsg = validateDocumentMaster(newName);
    if (errorMsg) {
            ...
            <div className="p-6">
              <Input
                ...
                onChange={(e: any) => {
                  ...
                  setNewName(val);
                  if (nameError) {
                    setNameError(validateDocumentMaster(val));
                  }
                }}
                onBlur={() => {
                  if (nameError || newName) {
                    setNameError(validateDocumentMaster(newName));
                  }
                }}
                error={nameError}
              />
