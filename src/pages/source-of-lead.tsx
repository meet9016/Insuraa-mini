      ...
      <div className="flex-1 flex flex-col md:flex-row gap-6 w-full">
        ...
        <div className="w-full md:w-[450px] shrink-0">
          <div className="bg-white rounded-md shadow-sm border border-gray-200/60 overflow-hidden">
            <div className="px-5 py-4 border-b border-gray-100 flex items-center gap-2">
              ...
              <h2 className="text-[16px] font-bold text-gray-900">Add Business Groups</h2>
            </div>

            <div className="p-5">
              <div className="mb-4">
                <label className="block text-[13px] font-medium text-gray-700 mb-2">Name <span className="text-[#e74c3c]">*</span></label>
                <input
                  type="text"
                  value={newName}
        ...
        <div className="flex-1 overflow-hidden w-full">
          ...
          <div className="flex justify-end items-center gap-1.5 text-sm text-[#2B4399] font-medium mb-4">
            ...
            <span className="text-gray-500">Add Business Groups</span>
          </div>
